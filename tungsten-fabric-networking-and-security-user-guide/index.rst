...
virtual networks using Tungsten Fabric. 
TF provides dynamic end-to-end networking policy and control 
...
TF security implements intent-based policy framework that uses policy constructs 
